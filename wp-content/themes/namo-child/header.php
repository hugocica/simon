...
<body <?php body_class(); ?>>		
	<div class="sb-slidebar <?php echo $sidebar_class; ?>">
		...
		<div class="social-medias">
        	...
        	<a target="_blank" href="https://facebook.com/shopsimon.us" class="facebook"></a>
        	<a target="_blank" href="https://twitter.com/shopsimon" class="twitter"></a>
        	<a target="_blank" href="http://www.youtube.com/user/SimonPropertyGroup" class="youtube"></a>
        	<?php /*<a target="_blank href="" class="seila"></a>*/ ?>
        	<a target="_blank" href="https://instagram.com/shopsimon" class="instagram"></a>
        </div>
	</div>
	<div id="main-wrapper">
