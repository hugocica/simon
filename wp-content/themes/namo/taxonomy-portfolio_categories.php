			...
			<div class="clearfix">
				<?php
					...
					if( have_posts() ) :
						...
						echo do_shortcode('['.$portfolio_style.' col= "'.$portfolio_col.'" show_filters= "no" filter = "categories" tax_name="portfolio_categories" category= "'.$term->slug.'" items_per_page="-1" pagination="none" overlay_color= "'.$portfolio_hover_color.'" overlay_opacity= "'.$portfolio_hover_opacity.'"]');
					else:
