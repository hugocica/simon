<?php
	class BE_Widget_Recent_Posts extends WP_Widget {
		function __construct() {
			$widget_ops = array('classname' => 'widget_recent_entries', 'description' => __( "The most recent posts on your site",'be_themes') );
			parent::__construct('be-recent-posts', __('Recent Posts','be_themes'), $widget_ops);
