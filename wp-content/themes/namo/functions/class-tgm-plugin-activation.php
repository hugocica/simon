				...
				if ( ! isset( $installed_plugins[$plugin['file_path']] ) ) {
					...
					if ( current_user_can( 'install_plugins' ) ) {
						if ( !empty($plugin['required']) && $plugin['required'] )
							$message['notice_can_install_required'][] = $plugin['name']; /** This plugin is only recommended */
						else
	...
	class TGMPA_List_Table extends WP_List_Table {
		...
		protected function _gather_plugin_data() {
			...
			foreach ( TGM_Plugin_Activation::$instance->plugins as $plugin ) {
				...
				$table_data[$i]['type'] = !empty($plugin['required']) ? __( 'Required', TGM_Plugin_Activation::$instance->domain ) : __( 'Recommended', TGM_Plugin_Activation::$instance->domain );
